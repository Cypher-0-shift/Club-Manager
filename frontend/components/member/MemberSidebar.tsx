          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', justifyContent: collapsed ? 'center' : 'flex-start' }}>
            ...
            {!collapsed && (
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: '11px', color: 'var(--color-text-primary)', fontWeight: 600, padding: '2px 6px', background: myDomain?.color_hex ? `color-mix(in srgb, ${myDomain.color_hex} 20%, transparent)` : 'var(--color-surface-hover)', border: `1px solid ${myDomain?.color_hex ? `color-mix(in srgb, ${myDomain.color_hex} 40%, transparent)` : 'var(--color-border)'}`, borderRadius: '4px', display: 'inline-block', marginTop: '2px' }}>
